...
game_map = load_map('mapfile')

grass_img = pygame.image.load('Imagens//grass.png')
dirt_img = pygame.image.load('imagens//dirt.png')

player_img = pygame.image.load('Imagens//player.png').convert()
...
while True:  # game loop
    ...
    player_movement = [0, 0]
    if speed_timer < 0.8 or vertical_momentum != 0:
        fps = 60
    else:
        fps = 70
    if moving_right:
